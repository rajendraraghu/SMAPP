...
import { MigrationProcessComponent } from 'app/entities/migration-process/migration-process.component';
...
describe('Component Tests', () => {
  describe('MigrationProcess Management Component', () => {
    let comp: MigrationProcessComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MigrationProcessComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.migrationProcesses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
