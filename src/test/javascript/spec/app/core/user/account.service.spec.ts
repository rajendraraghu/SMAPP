    ...
    describe('Service methods', () => {
      ...
      describe('hasAuthority', () => {
        it('should return false if user is not logged', async () => {
          const hasAuthority = await service.hasAuthority('ROLE_DEVELOPER');
      ...
      describe('hasAnyAuthority', () => {
        it('should return false if user is not logged', async () => {
          const hasAuthority = await service.hasAnyAuthority(['ROLE_DEVELOPER']);
          expect(hasAuthority).toBeFalsy();
        });
        ...
        it('should return true if user is logged and has authority', async () => {
          ...
          const hasAuthority = await service.hasAnyAuthority(['ROLE_DEVELOPER', 'ROLE_ADMIN']);
