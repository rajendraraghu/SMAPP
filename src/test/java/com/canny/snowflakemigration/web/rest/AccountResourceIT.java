...
import com.canny.snowflakemigration.config.Constants;
import com.canny.snowflakemigration.domain.Authority;
import com.canny.snowflakemigration.domain.User;
import com.canny.snowflakemigration.repository.AuthorityRepository;
import com.canny.snowflakemigration.repository.UserRepository;
import com.canny.snowflakemigration.security.AuthoritiesConstants;
import com.canny.snowflakemigration.service.MailService;
import com.canny.snowflakemigration.service.UserService;
import com.canny.snowflakemigration.service.dto.PasswordChangeDTO;
import com.canny.snowflakemigration.service.dto.UserDTO;
import com.canny.snowflakemigration.web.rest.errors.ExceptionTranslator;
import com.canny.snowflakemigration.web.rest.vm.KeyAndPasswordVM;
import com.canny.snowflakemigration.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIT {
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.DEVELOPER));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.DEVELOPER).get());
    }
