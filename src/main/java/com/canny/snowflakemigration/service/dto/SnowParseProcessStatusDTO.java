...
/**
 * A DTO for the {@link com.canny.snowflakemigration.domain.SnowParseProcessStatus} entity.
 */
public class SnowParseProcessStatusDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        SnowParseProcessStatusDTO SnowParseProcessStatusDTO = (SnowParseProcessStatusDTO) o;
        if (SnowParseProcessStatusDTO.getBatchId() == null || getBatchId() == null) {
            return false;
        }
        return Objects.equals(getBatchId(), SnowParseProcessStatusDTO.getBatchId());
    }
    ...
    public String toString() {
        return "SnowParseProcessStatusDTO{" +
            "batchId=" + getBatchId() +
