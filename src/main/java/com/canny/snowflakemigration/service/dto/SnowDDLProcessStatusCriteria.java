 ...
 */
public class SnowDDLProcessStatusCriteria implements Serializable, Criteria {
    ...
    public SnowDDLProcessStatusCriteria(){
    }

    public SnowDDLProcessStatusCriteria(SnowDDLProcessStatusCriteria other){
    ...
    @Override
    public SnowDDLProcessStatusCriteria copy() {
        return new SnowDDLProcessStatusCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SnowDDLProcessStatusCriteria that = (SnowDDLProcessStatusCriteria) o;
        return
