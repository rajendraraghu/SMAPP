...
/**
 * Criteria class for the {@link com.canny.snowflakemigration.domain.SnowDDLProcessStatus} entity. This class is used
 * in {@link com.canny.snowflakemigration.web.rest.SnowDDLProcessStatusResource} to receive all the possible filtering options from
 ...
 */
public class MigrationProcessStatusCriteria implements Serializable, Criteria {
    ...
    public MigrationProcessStatusCriteria(){
    }

    public MigrationProcessStatusCriteria(MigrationProcessStatusCriteria other){
    ...
    @Override
    public MigrationProcessStatusCriteria copy() {
        return new MigrationProcessStatusCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MigrationProcessStatusCriteria that = (MigrationProcessStatusCriteria) o;
        return
    ...
    public String toString() {
        return "MigrationProcessStatusCriteria{" +
                (jobId != null ? "id=" + jobId + ", " : "") +
