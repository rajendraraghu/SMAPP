 ...
 */
public class MigrationProcessJobStatusDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MigrationProcessJobStatusDTO)) {
            return false;
        }
        return jobId != null && jobId.equals(((MigrationProcessJobStatusDTO) o).jobId);
    }
    ...
    public String toString() {
        return "MigrationProcessJobStatusDTO{" +
            "jobId=" + getJobId() +
