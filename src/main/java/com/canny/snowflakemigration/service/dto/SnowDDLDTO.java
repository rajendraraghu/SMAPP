 ...
 */
public class SnowDDLDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        SnowDDLDTO SnowDDLDTO = (SnowDDLDTO) o;
        if (SnowDDLDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), SnowDDLDTO.getId());
    }
