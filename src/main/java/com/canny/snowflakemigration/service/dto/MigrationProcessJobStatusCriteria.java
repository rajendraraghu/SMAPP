 ...
 */
public class MigrationProcessJobStatusCriteria implements Serializable, Criteria {
    ...
    public MigrationProcessJobStatusCriteria(){
    }

    public MigrationProcessJobStatusCriteria(MigrationProcessJobStatusCriteria other){
    ...
    @Override
    public MigrationProcessJobStatusCriteria copy() {
        return new MigrationProcessJobStatusCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MigrationProcessJobStatusCriteria that = (MigrationProcessJobStatusCriteria) o;
        return
    ...
    public String toString() {
        return "MigrationProcessJobStatusCriteria{" +
