...
public class SnowHistoryResource {
    ...
    */
    ...
    public @ResponseBody String historyListTables(@Valid @RequestBody SnowHistoryDTO snowHistoryDTO) throws SQLException,ClassNotFoundException {
        ...
        conn_obj.addProperty("username",snowHistoryDTO.getSourceConnectionUsername());
        conn_obj.addProperty("password",snowHistoryDTO.getSourceConnectionPassword());
        conn_obj.addProperty("database",snowHistoryDTO.getSourceConnectionDatabase());
        conn_obj.addProperty("schema",snowHistoryDTO.getSourceConnectionSchema());
        conn_obj.addProperty("url",snowHistoryDTO.getSourceConnectionUrl());
        conn_obj.addProperty("system",snowHistoryDTO.getSourceSystem());
